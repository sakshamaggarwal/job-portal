...
def create_profile():
    ...
    service.create_profile(uci_netid, json_data['first_name'], json_data['last_name'], json_data['major'], json_data['year'], json_data['graduation_year'], json_data['gender'],
                           json_data['race'], json_data['disability'], json_data['veteran'], json_data['work_ex'], json_data['skills'], json_data['work_sponsorship'])
...
def add_application():
    ...
    json_data = request.json
    print(json_data.keys())
    service.save_and_update_application(json_data['uci_netid'], json_data['company'], json_data['status'], json_data['job_type'], json_data['link'], json_data['position'],
